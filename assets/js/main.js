...
/* swiper popular */
var swiperPopular = new Swiper(".popular-container, .logos-container", {
    spaceBetween:32,
    grabCursor:true,
    centeredSlides: true,
    slidesPerView:'auto',
...
/*VALUE ACCORDION */
const accordionItms = document.querySelectorAll('.value-accordion-item')
accordionItms.forEach((item) =>{
...
const toggleItem = (item) =>{
  const accordionContent = item.querySelector('.value-accordio-content')
